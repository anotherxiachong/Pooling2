...
public class CardsAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.itemImage = (ImageView) convertView.findViewById(R.id.list_item_card_good_image);
            holder.itemUser = (TextView) convertView.findViewById(R.id.list_item_card_user_name);
