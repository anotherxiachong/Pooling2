...
//					e.printStackTrace();
//				}
		    	Intent intent = new Intent(NearResultActivity.this, com.geniusgithub.lazyloaddemo.MainActivity.class);
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		...
		if(keyCode == KeyEvent.KEYCODE_BACK) {
			Intent intent = new Intent(NearResultActivity.this, BillPoolingActivity.class);
			startActivity(intent);
			NearResultActivity.this.finish();
			return true;
		} else {
