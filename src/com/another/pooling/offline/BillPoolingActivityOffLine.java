...
public class BillPoolingActivityOffLine extends Activity implements AMapLocationListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_near_offline);
		title = (TextView) findViewById(R.id.title_tv_near_offline);
		 title.setText("线下拼单-附近");
		 relativeLayout = (RelativeLayout) findViewById(R.id.near_offline_rela_lay);
			customFAB = (CustomFAB) findViewById(R.id.near_offline_add);
			customFAB.setOnClickListener(new OnClickListener() {
				
				@Override
				public void onClick(View v) {
					// TODO Auto-generated method stub
					new AddPopupWindows(BillPoolingActivityOffLine.this, relativeLayout);
				}
			});
...
//		});
		 ...
		 overflow = (TextView) findViewById(R.id.push_tv_near_offline);
			...
			mLeftMenu = (SlidingMenu) findViewById(R.id.id_menu_near_offline);
		 
		 search = (TextView) findViewById(R.id.search_tv_near_offline);
			search.setOnClickListener(new OnClickListener() {
				
				@Override
				public void onClick(View v) {
					// TODO Auto-generated method stub
					Intent intent  = new Intent(BillPoolingActivityOffLine.this, CitiesActivity.class);
					Bundle classes = new Bundle();
					classes.putString("classes", "search_offline");
	...
	private void getData(){
		...
		bmobQuery.findObjects(BillPoolingActivityOffLine.this, new FindListener<BillInfo>() {
		    @Override
		    public void onSuccess(List<BillInfo> object) {
		    	...
		    	if(object.size() == 0) {
		    		Toast.makeText(BillPoolingActivityOffLine.this, "没有找到哦~快去发起拼单吧~", Toast.LENGTH_LONG).show();
		    		BillPoolingActivityOffLine.this.finish();
		    	}
		    	string_dec= "";
		    	string_username="";
		    	string_no="";
...
//				}
		    ...
		    public void onError(int code, String msg) {
		        // TODO Auto-generated method stub
		    	Toast.makeText(BillPoolingActivityOffLine.this, "查询失败。+" + msg, Toast.LENGTH_LONG).show();
		    }
		});
	}
	...
	public void setupViews(int itemsCount, String[] urls, String[] des) {
		...
		mListview.setOnItemClickListener(new OnItemClickListener(){  
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent intent = new Intent(BillPoolingActivityOffLine.this, DetailResultActivityOffLine.class);
	...
	public class AddPopupWindows extends PopupWindow
	{
		...
		public AddPopupWindows(Context mContext, View parent)
		{
			...
			bt1.setOnClickListener(new OnClickListener()
			{
				public void onClick(View v)
				{
					Intent intent = new Intent(BillPoolingActivityOffLine.this, PublishedActivity.class);
					startActivity(intent);
					dismiss();
				}
			});
			bt2.setOnClickListener(new OnClickListener()
			{
				public void onClick(View v)
				{
					Intent intent = new Intent(BillPoolingActivityOffLine.this, PublishedActivityOffLine.class);
					startActivity(intent);
					dismiss();
				}
			});
